...
//   // ✅ Clear old map and legend
//   d3.select(mapContainerId).html("");
...
//   renderLegend(svg, colorScale, attribute, width, height);
// }

// function renderLegend(svg, colorScale, attribute, width, height) {
//   const legendWidth = 300;
//   const legendHeight = 10;
...
//   const defs = svg.append("defs");
//   const linearGradient = defs.append("linearGradient").attr("id", `legend-gradient-${Math.random()}`);
